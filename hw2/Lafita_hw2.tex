...
The key observation here is that each node's addition takes at most $27$ comparisons, and therefore, a growth rate of $O(1)$. 
...
and less than those to the right (barring where the character is either the or the greatest sequentially). 
...
Now, we will move on to array reconstruction.
