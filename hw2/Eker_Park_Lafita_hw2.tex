...
Therefore, we can build the following inequality:

$$n! \leq \#\text{leaves}\leq 3^d$$
...
We can simplify this further by finding a lower bound for the numerator and an upper bound for the demonenator to prove a lower bound 
