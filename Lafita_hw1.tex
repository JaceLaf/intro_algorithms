...
From here, I will recursively perform partitions of the list so that the first recursion finds the median of the array and splits it into $2$ equally-sized groups, 
...
Each recursive call doubles the number of groups, so it there would need to be $\log k$ calls. 
